...
def test_mlp(learning_rate=0.01, L1_reg=0.01, L2_reg=0.0001, n_epochs=1000,
             dataset='mnist.pkl.gz', batch_size=20, n_hidden1=1024, n_hidden2=50, n_hidden3=7):
    """
   ...
   """
    ...
    datasets = utils.load_data_with_test(True) # Load with mirrored dataset as well

    train_set_x, train_set_y = datasets[0],datasets[1]
    valid_set_x, valid_set_y = datasets[2], datasets[3]
    test_set_x, test_set_y = datasets[4], datasets[5]
    ...
    print train_set_x.shape, train_set_y.shape, train_set_x.shape
    raw_input('Loaded data')
    ...
    raw_input('train, valid, test Batches calculated')
    ######################
    # BUILD ACTUAL MODEL #
    ######################
    ...
    raw_input('Batch size and index')
    ...
    raw_input('Model functions compiled')
    # start-snippet-5
